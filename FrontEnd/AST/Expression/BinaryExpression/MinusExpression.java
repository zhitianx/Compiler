...
public class MinusExpression extends BinaryExpression{
    MinusExpression(Expression left,Expression right,Type type,boolean isleftvalue){
    ...
    public static Expression getExpression(Expression left,Expression right){
        if (left.type instanceof IntType && right.type instanceof IntType){
            ...
            return new MinusExpression(left,right,IntType.getType(),false);
        }
        throw new CompilationError("Minus wrong");
    }
}