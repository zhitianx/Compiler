...
public class NotgreaterExpression extends BinaryExpression{
    NotgreaterExpression(Expression left,Expression right,Type type,boolean isleftvalue){
    ...
    public static Expression getExpression(Expression left,Expression right){
        if (left.type instanceof IntType && right.type instanceof IntType){
            ...
            return new NotgreaterExpression(left,right,BoolType.getType(),false);
            ...
            return FunctioncallExpression.getExpression(
                    (Function)Environment.symboltable.getSymbol("_builtin_string_notgreater").type,
