...
public class LessExpression extends BinaryExpression{
    LessExpression(Expression left,Expression right,Type type,boolean isleftvalue){
    ...
    public static Expression getExpression(Expression left,Expression right){
        if (left.type instanceof IntType && right.type instanceof IntType){
            ...
            return new LessExpression(left,right,BoolType.getType(),false);
            ...
            return FunctioncallExpression.getExpression(
                    (Function)Environment.symboltable.getSymbol("_builtin_string_less").type,
        ...
        throw new CompilationError("illegal less");
    }
}