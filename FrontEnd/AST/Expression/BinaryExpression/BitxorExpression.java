...
public class BitxorExpression extends BinaryExpression{
    BitxorExpression(Expression left,Expression right,Type type,boolean isleftvalue){
    ...
    public static Expression getExpression(Expression left,Expression right){
        if (left.type instanceof IntType && right.type instanceof IntType){
            ...
            return new BitxorExpression(left,right,IntType.getType(),false);
        }
        throw new CompilationError("illegal bitxorexpression");
    }
}